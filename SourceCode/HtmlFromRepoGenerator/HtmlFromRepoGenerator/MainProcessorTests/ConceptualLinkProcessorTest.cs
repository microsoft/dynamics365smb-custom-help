...
namespace MainProcessorTests
{
    public class ConceptualLinkProcessorTest
    {
        ...
        [InlineData(
            "[Simple redirect with relative path](across-attach-document-master-data.md)",
            "[Simple redirect with relative path](ui-how-add-link-to-record.md)")]
        [InlineData(
            "[Redirect with path to parent](LocalFunctionality/Germany/how-to-enter-physical-inventory-orders.md)",
            "[Redirect with path to parent](inventory-how-count-inventory-with-documents.md)")]
        public void Test_ProcessContentLinks_Processes_Links(string input, string expected)
        {
            StringBuilder sb = new StringBuilder();
            Dictionary<string, string> redirectPairs = new Dictionary<string, string>()
            {
                { "across-attach-document-master-data.md", "ui-how-add-link-to-record" },
                { "LocalFunctionality/Germany/how-to-enter-physical-inventory-orders.md", "../../inventory-how-count-inventory-with-documents" },
            };
