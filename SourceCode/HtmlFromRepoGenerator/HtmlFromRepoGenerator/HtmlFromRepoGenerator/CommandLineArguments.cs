...
namespace HtmlFromRepoGenerator
{
    ...
    public class CommandLineArguments : CmdLineObject
    {
        ...
        public string Json = "business-central/";
        public string ReplaceUrl = "http://docs.microsoft.com";
        ...
        protected override string[] Validate()
        {
            ...
            if (string.IsNullOrEmpty(Json) || Json != null && !Json.Equals("business-central/", StringComparison.InvariantCultureIgnoreCase))
            {
                errors.AddLast(@"Please specify 'business-central/' in --json parameter.");
            }
