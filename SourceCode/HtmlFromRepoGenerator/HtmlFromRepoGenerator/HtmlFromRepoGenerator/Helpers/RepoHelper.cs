namespace HtmlFromRepoGenerator.Helpers
{
    ...
    public class RepoHelper
    {
        ...
        /// <summary>
        /// Checks the cloned repository for the .openpublishing.redirection.json file.
        /// </summary>
        /// <param name="outDir">The out dir.</param>
        /// <param name="path">The result path to .openpublishing.redirection.json file.</param>
        /// <returns>True if OK</returns>
        public static bool TryToCheckClonedRepoOpenPublishingRedirectionJson(string outDir, out string path)
        {
            path = Path.Combine(outDir, ".openpublishing.redirection.json");
            return File.Exists(path);
        }
        #endregion
